...
insert into store_product (id, title, description, unit_price, inventory, updated_at, collection_id, slug)
...
ALTER SEQUENCE store_customer_id_seq RESTART WITH 1001;
ALTER SEQUENCE store_order_id_seq RESTART WITH 1001;
ALTER SEQUENCE store_orderitem_id_seq RESTART WITH 1001;
